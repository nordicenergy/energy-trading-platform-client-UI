[![Gitpod Ready-to-Code](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/nordicenergy-blockchain/energy-use-case-trading-client) 

# Nordic Energy Energy Use Case Frontend
...
## Introduction
[nordicenergy](https://www.powerchain.nordicenergy.io) is developing the only scalable public-private blockchain with deletable data features, made for commercial products. Designed with nordicenergy's live P2P trading use case, and co-innovated with SAP.
